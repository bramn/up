...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { icon: @menu_item.icon, name: @menu_item.name, order: @menu_item.order, page_id: @menu_item.page_id } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { icon: @menu_item.icon, name: @menu_item.name, order: @menu_item.order, page_id: @menu_item.page_id } }
