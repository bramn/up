...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post folders_url, params: { folder: { base_name: @folder.base_name, parent_folder: @folder.parent_folder, path: @folder.path } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { base_name: @folder.base_name, parent_folder: @folder.parent_folder, path: @folder.path } }
